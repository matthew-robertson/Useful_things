...
1. "Tech debt is like fast food. Occasionally it's acceptable but if you get used to it, it'll kill the product faster than you think (and in a painful way)." - [Alex Ewerlöf](https://alexewerlof.medium.com/my-guiding-principles-after-20-years-of-programming-a087dc55596c)
...
1. Advice about [reviewing code you don't like](https://developers.redhat.com/blog/2019/07/08/10-tips-for-reviewing-code-you-dont-like#summary). It all boils down to "don't be an asshole, be constructive, but there's some good concrete options in there.
1. General advice about [giving](https://mtlynch.io/human-code-reviews-1/) and [receiving](https://mtlynch.io/code-review-love/) code reviews. The biggest advice? Just ask questions.
...
1. "Adding friction is just fine when it buys you something worthwhile." - ["Reducing Friction", C J Silverio](https://blog.ceejbot.com/posts/reduce-friction/)
1. One way to optimize for readability is to minimize indentation. [Guard statements](https://en.wikipedia.org/wiki/Guard_(computer_science)) are one way to do that, and Mat Ryer talks about it generally [here](https://medium.com/@matryer/line-of-sight-in-code-186dd7cdea88)
