...
1. zDoom's API is powerful, but an [absolute shambles](https://eev.ee/blog/2016/04/21/elegance/#zdoom-and-pickactor) to work with for something as longstanding and formative as it is. Specific attention is drawn to the ness that is properly selecting an `actor` (read, entity) to operate on.
...
1. The Japanese government used a partnership with Capcom in 2021 to [use Ace Attorney Characters to combat cannabis abuse](https://www.nintendolife.com/news/2021/12/random-ace-attorney-says-objection-to-drugs-in-japanese-anti-marijuana-campaign).
